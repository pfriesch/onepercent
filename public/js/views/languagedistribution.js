/**
 * View for a LanguageDistribution.
 * @author Patrick Mariot
 */
var LanguageDistributionView = Backbone.View.extend({
	/**
	...
	initialize: function(options) {
		...
		this.dataCollection = new LanguageCountCollection(this.path.table, this.path.date, this.path.hour);
	 ...
	 */
	showChart: function(){
		var names = this.dataCollection.getLanguages();
